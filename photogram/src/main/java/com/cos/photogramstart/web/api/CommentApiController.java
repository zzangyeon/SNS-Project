...
public class CommentApiController {
	...
	public ResponseEntity<?> commentSave(@Valid @RequestBody CommentDto commentDto,BindingResult bindingResult,@AuthenticationPrincipal PrincipalDetails principalDetails){//그냥 받으려면 x-www-form-urlencoded 방식이어야한다. json을 받으려면 @RequestBody써야함		
